        ...
        {#each Array(fields) as _, i}
          <fieldset class="form-inline mb-3">
            <div class="form-group mr-3">
              ...
              <input type="text" name="name[]" id="name{i}" class="form-control ml-2" placeholder="Name" required>
            </div>

            <div class="form-group mr-3">
              <label for="key-path{i}">Key Path:</label>
              <input type="text" name="key-path[]" id="key-path{i}" class="form-control ml-2" placeholder="Key path">
            </div>

            <div class="form-group mr-3">
              <label for="auto-increment{i}">Auto increment:</label>
              <select class="custom-select ml-2" name="auto-increment[]" id="auto-increment{i}">
